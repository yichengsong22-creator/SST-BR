"""Synthetic signals and the executable partial-release data-flow demo."""
...
from ..demo_core import DemoCore
...
def run_structural_demo(seed: int = 2026) -> dict:
    """Run every public demo stage without requesting the exact paper core."""
